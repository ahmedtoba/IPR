...
def result():
    ...
    if request.method == 'POST':
        ...
        return render_template('index.html', myChart=myChart, result=result, Bop=Bop, Bof=Bof, Pwf=tabPwf, qop=tabqop, qoft=tabqoft, Prp=Prp, Prf=Prf, Uop=Uop, Uof=Uof, Sop=Sop, Sof=Sof, krop=krop, krof=krof, pwf=pwf, qo=qo, step=step)
